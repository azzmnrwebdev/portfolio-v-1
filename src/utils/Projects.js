...
const projects = [
  {
    ...
    link_source: "https://github.com/azzmnrwebdev/portfolio-v-1",
    files: [
      {
        type: "image",
        path: Portfolio,
  ...
  },
  {
    ...
    link_source: "https://github.com/azzmnrwebdev/cheriewish",
    files: [
      {
        type: "image",
        path: Cheriewish,
  ...
  },
  {
    ...
    role: "Frontend Developer",
    technology: "Flutter",
    link_demo: "https://youtu.be/hVaArqUgFfo",
    link_source: null,
    files: [
      {
        type: "image",
